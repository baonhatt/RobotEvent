...
export default function PhoneButton({ phone }: PhoneButtonProps) {
  return (
    <motion.a
      ...
      aria-label="Call us"
    >
      {/* Single wave effect – two simultaneous pings are unnecessary on mobile */}
      <div className="absolute inset-0 rounded-full bg-green-500 motion-safe:animate-ping opacity-25"></div>
